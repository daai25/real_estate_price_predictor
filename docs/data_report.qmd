...
- **Reproducibility**: Executable with documented script under the [Urbanhome Scraper](https://github.com/daai25/real_estate_price_predictor/blob/main/data_acquisition/urbanhome/urbanhome/spiders/properties.py) script in the repository
